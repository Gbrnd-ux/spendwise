...
export default function Sidebar() {
    ...
    return (
        <aside
            className={`hidden lg:flex flex-col h-screen sticky top-0 border-r border-white/5 bg-[#0B1120]/80 backdrop-blur-xl transition-all duration-300 ${isCollapsed ? "w-20" : "w-64"
                }`}
        >
            {/* Logo */}
